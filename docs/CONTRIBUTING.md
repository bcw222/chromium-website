...
3.  Make your changes! Check out [AUTHORING.md](AUTHORING.mg) for guidelines.
...
6.  Check in your changes and upload a CL to the Gerrit code review server.
    ...
    *NOTE:* If this is your first time contributing something to Chromium
    ...
    as noted above, and also
    add yourself to the [//AUTHORS](../AUTHORS) file as part of your change.
