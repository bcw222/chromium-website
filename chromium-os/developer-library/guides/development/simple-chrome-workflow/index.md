...
title: Simple Chrome Workflow
---

# Building Chrome for ChromeOS (Simple Chrome)
...
your `~/.boto` file. See the [gsutil setup documentation](gsutil.md#setup) for
more details.
...
*   If you run into Google Storage authentication issues, be sure to follow
    the gsutil [setup](gsutil.md#setup) instructions.
...
[Shell-less flow]: #Shell_less-flow
