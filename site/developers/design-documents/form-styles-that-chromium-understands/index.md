...
<form id="login" action="login.php" method="post">
  <!-- user invisible -->
  <input id="username" type="email" value="user@example.com" autocomplete="off">
...
There are also useful [autocomplete attribute values for annotating address forms](https://developers.google.com/web/updates/2015/06/checkout-faster-with-autofill) and [Sign-in form best practice](https://web.dev/sign-in-form-best-practices/)