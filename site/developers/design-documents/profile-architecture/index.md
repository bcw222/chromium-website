...
Note: `ProfileKeyedServiceFactory` is an intermediate interface that itself 
derives from `BrowserContextKeyedBaseFactory` adding functionalities on profile
...
under chrome/ because PKSF provides a better default behavior for irregular
profiles.
