...
You can also install the WinDbg Preview, the new/preview version of WinDbg, from
the Microsoft Store or [this link](https://aka.ms/windbg/download). Discussion
of various issues around getting this version can be found [here](https://github.com/microsoftfeedback/WinDbg-Feedback/issues/19#issuecomment-1512275411).
