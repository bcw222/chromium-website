...
Instead, we us a wrapper script. The instructions for this script can be found
[here](https://source.chromium.org/chromium/chromium/src/+/main:tools/perf/recording_benchmarks.md).
