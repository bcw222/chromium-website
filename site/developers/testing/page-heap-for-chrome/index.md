...
processes. See crbug.com/1004989 for details. Application Verifier can be used
on non-official developer builds, but you should probably close stable Chrome to
avoid having it crash. See also [this
