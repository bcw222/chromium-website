...
a test number ending in 1, and ends with a test number ending in 0, e.g., 3541
and 3550.
...
But, on Windows, the key event handler does a ::PeekMessage, which can cause a
loss of focus. So if the test generates key events, that can trigger loss of
focus. See this bug[1330440](https://crbug.com/1330440). One option is to make
