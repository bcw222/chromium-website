...
The OWP security review Intent flow
[go/chrome-sp-owp-review-queue](go/chrome-sp-owp-review-queue) (Google-internal, sorry) is a
separate process
...
ISE review covers internal Google services, which the Chrome Security review does not cover.
