...
#### Informal pre-review:
If your project is especially tricky or large, it's best to reach out to security@chromium.org 
(for public stuff; preferable) or chrome-security@google.com (for Google confidential stuff)
well ahead of time for an early design review or feedback on your design doc.
This doesn't mean you will be assigned a reviewer/POC but reviewers will drive by with feedback.
If we provide no feedback via this channel (likely by unfortunate email physics), please reach out
and we will give the doc the attention it deserves! 
...
ISE review: The approval from the formal review (via Launch) does not cover internal Google services
OWP security review: Intent-to-implement flow [go/chrome-sp-owp-review-queue](go/chrome-sp-owp-review-queue) (Google-internal, sorry)
