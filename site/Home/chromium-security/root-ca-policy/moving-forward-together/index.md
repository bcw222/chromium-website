...
<span style="text-decoration:underline;">Understanding dedicated hierarchies:</span>
...
The following initiatives are planned for future exploration by the Chrome Root Program Team. As observed with several areas of past exploration, for example "[Multi-Perspective Issuance Corroboration](https://docs.google.com/document/d/1z3Ai3DjbL3tE4hVdizLps0ngl9fApBFfqZlFMRo1xjk/edit?resourcekey=0-_3HFJr5o362f7Z024plheA&tab=t.0#heading=h.au0tsm8pok1e)," the Chrome Root Program Team looks forward to pursuing these security-enhancing initiatives within the CA/Browser Forum Server Certificate Working Group, when appropriate.
...
<span style="text-decoration:underline;">Understanding Multi-Perspective Issuance Corroboration:</span>
...
The Chrome Root Program [led](https://drive.google.com/drive/folders/1dn6ZsTJGghKIFyVJwBUdIeeUhM4-sQBz) a work team of ecosystem participants which culminated in a CA/Browser Forum Ballot to require adoption of MPIC (i.e., SC-067). The ballot received unanimous support from organizations who participated in voting, and the [adoption process](https://github.com/cabforum/servercert/pull/517) is ongoing.
...
<span style="text-decoration:underline;">Understanding linting:</span>
...
The Chrome Root Program participated in drafting a CA/Browser Forum Ballot (SC-075) to require adoption of certificate linting. The ballot received unanimous support from organizations who participated in voting, and the [adoption process](https://github.com/cabforum/servercert/pull/518) is ongoing.
...
In Chrome Root Program Policy 1.5, we [landed](https://www.chromium.org/Home/chromium-security/root-ca-policy/#root-ca-term-limit) changes that require Applicant hierarchies to support automated certificate issuance and management. For more information on automation, refer to our blog post: "[Unlocking the power of automation for a safer and more reliable Internet.](https://blog.chromium.org/2023/10/unlocking-power-of-tls-certificate.html)"
