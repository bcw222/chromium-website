...
\* while existing CA certificates trusted by Chrome *may* have EKU values as described in this table, applicant CAs **must** be a part of a [dedicated to TLS PKI hierarchy](#4-dedicated-tls-pki-hierarchies)<br>
