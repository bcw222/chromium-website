...
2. Record add submit your talk by completing Columns E to H in [this sheet](https://docs.google.com/spreadsheets/d/1krAIrq6crZ7M07Uy4FLY-MAiontOecPMjeWrvCWr2m0/edit#gid=0) by **Wednesday, May 4th (hard deadline) **
...
1. If you're creating slides, consider using [this template](https://docs.google.com/presentation/d/1VvlBAn67d9UDMsvUlnxTqWdlh4KcbEoV36840HR88jU/copy)
...
2. Screen Sharing
    3. Click the Screen sharing icon at the bottom of the page
    4. Switch to Chrome Tab on the popup window and choose the required browser tab
    5. Check the Share audio box
