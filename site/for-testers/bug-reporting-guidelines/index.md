...
*   Report bugs at <https://issues.chromium.org/issues/wizard>
*   Specifically:
...
<<<<<<< PATCH SET (fb04a8 updated documentation for new issues tracker)
...
>>>>>>> BASE      (8f3147 Describe 'Available' issue state.)
