...
*   Report bugs at <https://g-issues.chromium.org/issues/wizard>
*   Specifically:
    ...
    *  View existing bugs at <https://g-issues.chromium.org/issues?q=status:open>

### Chromium OS (the operating system)

*   Report bugs at [Chromium Issue Tracker](https://g-issues.chromium.org/issues/new?noWizard=true&component=1363614&template=1922563)
*   View existing bugs at [Chromium OS
            issues](https://g-issues.chromium.org/issues?q=status:open%20os:chromeos)
