...
When a site that wishes to participate in the Origin Trial, they should include the following headers in their response:
...
Frames that [opt into the Origin Trial](http://googlechrome.github.io/OriginTrials/developer-guide.html) will have access to reading and writing partitioned cookies.
Frames that are not in the trial will neiter be able to read nor write partitioned cookies.
