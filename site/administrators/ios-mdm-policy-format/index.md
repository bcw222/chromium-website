...
The page at <http://www.chromium.org/administrators/policy-list-3> indicates
which platforms are supported for each policy. It will list policies for iOS
once it's updated to version 35. Note that the examples above are exhaustive as
of version 35.
