...
> and [public bug tracker](https://g-issues.chromium.org/).

**I found a bug in Chrome that I need fixed. Who should I contact and when can I
expect it fixed?**

> [Please file a bug](https://g-issues.chromium.org/issues/wizard) in our
...
> know](https://g-issues.chromium.org/issues/wizard) by filing a bug.
