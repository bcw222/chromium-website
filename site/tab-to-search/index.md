...
document][osdd].
    ...
    [OpenSearch description document specification][osdd] for the list of values you can specify.
...
[osdd]: http://www.opensearch.org/Specifications/OpenSearch/1.1#OpenSearch_description_document