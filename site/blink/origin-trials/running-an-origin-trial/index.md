...
2.  Feature changes, new areas experimentation, or reviving dortmant features
    *   As the origin trial progress, you may determine that a feature
                ...
                you uncover new hypotheses for experimentation. In yet other cases
                you may be returning to a dormant feature launch to start
                experimenting again after the previous trial has long ended.
...
The process is as follows, depending on which of the two scenarios in the section above
your case belongs:

*   If desired, email
            [origin-trials-support@google.com](mailto:origin-trials-support@google.com)
            to consult on the appropriate approach.
*   If extending the end date of the existing trial (scenario 1 above):
    ...
    *   Select the "Finalize Trial Extension" button that is now available in the Origin
                Trial section.
*   Otherwise if continuing to experiment via a new trial (scenario 2 above):
