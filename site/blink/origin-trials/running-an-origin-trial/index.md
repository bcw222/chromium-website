...
Origin trials start out running up to 6 milestones, and can be extended under certain conditions.
See [here](https://www.chromium.org/blink/launching-features/#step-3-optional-origin-trial) for
more details.
...
requesting an extension to the trial end date. For feature changes and such (2), this generally means
starting a new origin trial, to follow the previous trial.

In order to be eligigle for an extension, you must demonstrate substantial progress towards
meeting the bar for shipping the feature. See [here](https://www.chromium.org/blink/launching-features/#step-3-optional-origin-trial)
for more details.
