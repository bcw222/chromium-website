...
* Can the change cause user-visible or functional breakage? 
  ...
  coding pattern is used in the wild? An [HTTPArchive](https://httparchive.org/)
 analysis can help with such an assessment.
...
For either a PSA or an intent-to-ship, placing the code change behind a
[flag](https://chromium.googlesource.com/chromium/src/+/main/third_party/blink/renderer/platform/RuntimeEnabledFeatures.md)
would enable us to quickly roll-back that change in case that our estimate
