...
Each subsequent request to extend the a trial must provide substantial *additional* 
progress on top of the previous extension request.

[Note: the required breaking period was removed in April 2022. This removal will run for 12 months, after which the
API owners will review consider making the change permanent.]
