...
If you're writing the explainer for:
* Google: put your explainer in <https://github.com/explainers-by-googlers>.
* Microsoft: put your explainer in
  <https://github.com/MicrosoftEdge/MSEdgeExplainers>.
* Another organization: if your organization has an area for explainers, [send
  us a
  patch](https://source.chromium.org/chromium/chromium/src/+/main:docs/website/docs/CONTRIBUTING.md)
  to describe it here.
* Yourself or an organization without an explainers area: Put your explainer at any public
  URL, often in a public personal Github repo.

Then put a link to your public explainer in the feature entry.
