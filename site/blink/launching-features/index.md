...
other engines and to spec
editors](https://groups.google.com/a/chromium.org/g/blink-dev/c/1wWhVoKWztY/m/j41ZKsRXBwoJ)
in order to ensure that the feature is removed in a coordinated way. We usually
don't want to try to remove a feature from Chromium if Gecko and WebKit are
going to keep supporting it.
...
Have Chrome Status generate an “Intent to Deprecate and Remove” mail for you,
send it to [blink-dev](mailto:blink-dev@chromium.org), and wait for 3 LGTMs.

Once [the API owners have given 3
LGTMs](http://localhost:8080/blink/guidelines/api-owners/procedures/) for your
removal plan, start checking in your code to add a [runtime enabled
...
#### Step 6: Wait for the removal to land {:#wait-for-landing}
...
#### Step 7: Remove Code {:#remove-code}
