...
2. Request a [Specification
   ...
   Note that if the TAG review takes long and the design is being matured elsewhere, to the
   point where a TAG review would no longer be helpful, it's best to notify the TAG so that
   they can close the issue and prioritize other issues.
