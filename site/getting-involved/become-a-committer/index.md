...
address to be re-nominated. To do so, send an email to committers@ with
the changes you want and get at least one other committer to vouch for you by
confirming those changes in a reply to that email.
