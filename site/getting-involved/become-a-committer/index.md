...
existing committer account to accounts@chromium.org asking for the changes you
want or (if you can't or don't want to do that) get at least one other committer
