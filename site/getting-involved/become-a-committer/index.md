...
because a one-line change might be subtle, and changes that touch
...
you won't normally need a hundred CLs to find ten that qualify, and if you
aren't certain whether your work meets the bar, just ask an existing committer.
...
fulfill [a responsibility we call
gardening](https://chromium.googlesource.com/chromium/src/+/main/docs/gardener.md).
The important point here is that non-Google committers cannot be gardeners and
thus aren't expected to do so. This restriction is largely because we only
want to require this from people who are being paid to do this as part of their
jobs. However, gardening also can involve using tools that aren't public and
looking at builders that aren't public.
