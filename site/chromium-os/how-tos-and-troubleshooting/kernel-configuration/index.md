...
*   Look for the kernel config option you want to edit in the family you are
    interested in. Following example uses chromeos family.
...
*   Now edit that file `chromeos/config/chromeos/base.config` to change the
            config like this:
