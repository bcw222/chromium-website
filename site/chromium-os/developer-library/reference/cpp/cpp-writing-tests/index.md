...
[E2E tests](site/chromium-os/developer-library/reference/development/e2e_tests/index.md) are automated tests performed on actual Chromebooks. A
...
[fakes](site/chromium-os/developer-library/reference/cpp/cpp-patterns/index.md##abstract-base-class-impl-fake). As a bonus, code
...
See [Stubbing Mojo Pipes](site/chromium-os/developer-library/reference/cpp/cpp_mojo/index.md#stubbing-mojo-pipes) for pointers on how
