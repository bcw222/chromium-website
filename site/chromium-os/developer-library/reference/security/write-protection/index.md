...
device and disconnecting the battery may still disable write protection. If
disconnecting the battery does not disabled write protection immediately, then
see the [guide for firmware unlock on 2023+ devices].
