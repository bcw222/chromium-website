...
# Note perf keyvals described in this page has been deprecated. If your test output perf values, please refer to <http://www.chromium.org/chromium-os/developer-library/guides/testing/perf-data/perf-data>
