...
[setup your test Chromebook](../setup-chromebook) such that you will be able to
deploy your custom builds to the device. If you don't have a test Chromebook,
skip ahead to [Checkout Chromium](../checkout-chromium) to continue with the
