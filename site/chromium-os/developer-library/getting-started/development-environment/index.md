...
Now that your workstation is ready for development, you'll modify your test
Chromebook such that you will be able to deploy your custom builds to the
device. If you don't have a test Chromebook, skip ahead to
[Checkout Chromium](../checkout-chromium) to continue with the
workstation-only development flow.
