...
- - /chromium-os/developer-library/guides
  - Chromium OS > Developer Library > Guides
page_name: broken-build
title: Broken Build Troubleshoot
---
...
[Building Chrome](https://www.chromium.org/chromium-os/developer-library/getting-started) section for more details around
these steps.
...
2.  You should still be able to SSH into the machine when in this state. Consult
    [Viewing logs](https://www.chromium.org/chromium-os/developer-library/guides/logging/logging) -- investigate logs and
    ...
    2. If you are still unable to SSH into the machine, flash a new image from
       ...
       [Setting up your Chromebook](setup_chromebook.md) for details.
3.  Make sure your platform version isn't too old. Sometimes updating your
    ...
    with your Chrome build. See [Flashing ChromiumOS](https://www.chromium.org/chromium-os/developer-library/guides/device/flashing-chromiumos)
    for details.
