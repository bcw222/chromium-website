...
you're storing. This may be a PM decision, so please check with the design
team before adding a preference.
...
## Using Policies
Before implementing a policy, please check with your PM on whether it makes
sense to introduce a new policy. Also please keep in mind that for launch
reviews, these policies will be reviewed by the enterprise/edu review team.
