...
project. Run:
`cros_sdk --working-dir=. -- cargo --config 'source.crates-io.directory="/usr/lib/cros_rust_registry/registry"' generate-lockfile`
outside the chroot in the crate root. Also make sure to allow the `Cargo.lock`
in the `.gitignore` of your crate.
