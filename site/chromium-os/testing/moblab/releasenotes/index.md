...
*   Trimming leading/trailing spaces from the key, value, pool, and label inputs

*   Renaming Name column to DUT

**UI - DUT Detail**

*   Removing obsolete Name field
...
*   Fix the link shown when sending logs
