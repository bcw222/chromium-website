...
breadcrumbs: - - /chromium-os - Chromium OS - - /chromium-os/build - Chromium OS
Build page_name: sdk-creation
...
\  
SDK_LATEST_VERSION="2022.03.17.105954" </code></pre>
...
The version of the SDK to use is stored in:

<pre><code>
[src/third_party/chromiumos-overlay/chromeos/binhost/host/sdk_version.conf](https://chromium.googlesource.com/chromiumos/overlays/chromiumos-overlay/+/master/chromeos/binhost/host/sdk_version.conf)
\  
BOOTSTRAP_FROZEN_VERSION="2020.11.09.170314" </code></pre>
...
[create and upload the SDK tarball](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/sdk_stages.py#127).
...
It's likely that just building the SDK board itself would be sufficent for most
