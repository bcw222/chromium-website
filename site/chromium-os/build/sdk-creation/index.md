...
[chromite/bin/](https://chromium.googlesource.com/chromiumos/chromite/+/main/scripts/cros_sdk.py))
...
[src/third_party/chromiumos-overlay/chromeos/binhost/host/sdk_version.conf](https://chromium.googlesource.com/chromiumos/overlays/chromiumos-overlay/+/main/chromeos/binhost/host/sdk_version.conf):
...
place? The chromiumos-sdk builder--referred to as the “SDK builder”--builds each
...
*   Upload binary package artifacts to make available
...
stored in
[sdk_version.conf](https://chromium.googlesource.com/chromiumos/overlays/chromiumos-overlay/+/main/chromeos/binhost/host/sdk_version.conf):
...
[`update_chroot`](https://chromium.googlesource.com/chromiumos/platform/crosutils/+/refs/heads/main/update_chroot)
and setting up the chroot SDK environment.

### Build the SDK (amd64-host) board

The first step of the creation of the new SDK is for the SDK builder to
[build the special amd64-host board](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/build_stages.py#554).
...
[src/scripts/build_sdk_board](https://chromium.googlesource.com/chromiumos/platform/crosutils/+/refs/heads/main/build_sdk_board)
...
To
[build and install the toolchains](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/sdk_stages.py#75),
the cbuildbot process will then run
[`cros_setup_toolchains`](https://chromium.googlesource.com/chromiumos/chromite/+/main/scripts/cros_setup_toolchains.py)
...
[create then upload the SDK tarball](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/sdk_stages.py#127)
...
[To test this](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/sdk_stages.py#309),
...
[upload the binary packages](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/artifact_stages.py#645)
for the SDK itself.
...
[upreved](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/cbuildbot/stages/sdk_stages.py#379)
...
[chromite/lib](https://chromium.googlesource.com/chromiumos/chromite/+/refs/heads/main/lib/))
