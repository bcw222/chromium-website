...
note: if you're looking to copy game installations (not saves) you may want to make use of
[Steam's Backup feature](https://help.steampowered.com/en/faqs/view/4593-5cb7-dc3c-64f0)
. Make sure to select `/mnt/shared/MyFiles/Downloads` as the folder to use and be careful
managing the available disk space, as it may not be reported accurately.
